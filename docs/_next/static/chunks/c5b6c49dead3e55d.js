(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	(e, t, n) => {
		...
		var t2 = tM(
			...
			t8 = tM(h({}, t$, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 })),
			t5 = tM(
				h({}, tW, {
					deltaX: function (e) {
						return 'deltaX' in e
			...
			t6 = tM(h({}, t$, { newState: 0, oldState: 0 })),
			t9 = [9, 13, 27, 32],
		...
		function uO() {
			if (4 === i8 || 3 === i8) {
				...
				0 != (10256 & t.subtreeFlags) || 0 != (10256 & t.flags)
					? (i8 = 5)
					: ((i8 = 0), (i6 = i5 = null), uT(e, e.pendingLanes));
		...
		function uC() {
			...
			try {
				...
				var l = i5,
					o = i9;
				if (((i8 = 0), (i6 = i5 = null), (i9 = 0), 0 != (6 & ij)))
					throw Error(u(331));
				var i = ij;
				if (
					((ij |= 4),
		...
		(() => {
			...
			'undefined' != typeof __nccwpck_require__ &&
				(__nccwpck_require__.ab =
					'/ROOT/node_modules/.pnpm/next@16.0.1_@babel+core@7.28.5_babel-plugin-react-compiler@1.0.0_react-dom@19.2.0_react@19.2.0__react@19.2.0/node_modules/next/dist/compiled/path-to-regexp/');
			var e = {};
			((() => {
				function t(e, t) {
					void 0 === t && (t = {});
...
${t}`),
			...
			((r.ab =
				'/ROOT/node_modules/.pnpm/next@16.0.1_@babel+core@7.28.5_babel-plugin-react-compiler@1.0.0_react-dom@19.2.0_react@19.2.0__react@19.2.0/node_modules/next/dist/compiled/safe-stable-stringify/'),
				(t.exports = r(879)));
		})();
	},
	5838,
	(e, t, n) => {
		...
		let o = e.r(9200),
			i = (r = e.r(7843)) && r.__esModule ? r : { default: r };
		function u(e) {
			return (
	...
	(e, t, n) => {
		...
		let r = e.r(1691);
		function a(e) {
			return (0, r.pathHasPrefix)(e, '/words');
		}
		('function' == typeof n.default ||
			('object' == typeof n.default && null !== n.default)) &&
			void 0 === n.default.__esModule &&
...
${e.stack}`
	...
	(e, t, n) => {
		...
		async function X(t = {}) {
			...
			if (
				...
				let { initScriptLoader: t } = e.r(4924);
				t(a.scriptLoader);
			}
					...
					.then(({ page: r, styleSheets: a }) =>
						s?.Component === r
							? e
									.A(6284)
									.then((r) =>
										e.A(2969).then((e) => ((t.App = n = e.default), r)),
									)
	...
	(e, t, n) => {
		'use strict';
		(Object.defineProperty(n, '__esModule', { value: !0 }), e.r(9388));
		let r = e.r(7475),
			a = e.r(2958);
		((window.next = {
			version: r.version,
