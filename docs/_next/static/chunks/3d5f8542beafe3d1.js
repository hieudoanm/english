(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
					...
					((i.nextTick = function (e) {
						...
						if (arguments.length > 1)
							for (var r = 1; r < arguments.length; r++)
								t[r - 1] = arguments[r];
						(u.push(new d(e, t)), 1 !== u.length || c || o(f));
					}),
	...
	(e, t, r) => {
		...
		((O.constructor = _), b(O, w.prototype), (O.isPureReactComponent = !0));
		var C = Array.isArray;
		function E() {}
				...
				!(function e(t, r, n, a, o) {
							...
							case 'object':
								switch (t.$$typeof) {
									...
									case s:
										...
										break;
									case p:
										return e((f = t._init)(t._payload), r, n, a, o);
								}
						}
					if (f)
						return (
					...
					if (C(t))
						...
						for (t = y.call(t), y = 0; !(a = t.next()).done; )
							((h = d + x((a = a.value), y++)), (f += e(a, r, n, h, o)));
					else if ('object' === h) {
		...
		((r.Activity = y),
			...
			(r.cloneElement = function (e, t, r) {
				...
				var n = b({}, e.props),
					i = e.key;
				if (null != t)
					for (s in (void 0 !== t.key && (i = '' + t.key), t))
						T.call(t, s) &&
							'key' !== s &&
							'__self' !== s &&
							'__source' !== s &&
				...
				if (1 === s) n.children = r;
					...
					for (var a = Array(s), o = 0; o < s; o++) a[o] = arguments[o + 2];
					n.children = a;
				}
				return M(e.type, i, n);
			}),
	...
	(e, t, r) => {
		...
		let y = function ({ children: e }) {
			let t = (0, u.useContext)(l.HeadManagerContext);
	...
	(e) => {
		...
		function f(e, t) {
			...
			if (s) {
				...
				} else if (!y(t.options.mutationKey, s)) return !1;
			}
	...
	(e) => {
		'use strict';
		let t, r, n, i, s, a;
		var o = e.i(9970).systemSetTimeoutZero,
			u =
				((t = []),
				(r = 0),
				(n = (e) => {
	...
	(e) => {
		...
		(e.s(['onlineManager', () => s], 1117),
			e.s(['pendingThenable', () => a], 1423));
		...
		function l(e) {
			let r,
				...
				f = () =>
					...
					('always' === e.networkMode || s.isOnline()) &&
					e.canRun(),
		...
		var h = e.i(9970),
			f = class {
				...
				scheduleGc() {
					(this.clearGcTimeout(),
						(0, t.isValidTimeout)(this.gcTime) &&
							(this.#a = h.timeoutManager.setTimeout(() => {
								this.optionalRemove();
							}, this.gcTime)));
				}
				updateGcTime(e) {
				...
				clearGcTimeout() {
					this.#a &&
						(h.timeoutManager.clearTimeout(this.#a), (this.#a = void 0));
				}
			};
		...
		var d = class extends f {
			...
			setOptions(e) {
				if (
					...
					void 0 !== e.data &&
						(this.setState(y(e.data, e.dataUpdatedAt)), (this.#o = e));
				}
			}
			optionalRemove() {
		...
		e.s(['QueryClientProvider', () => S, 'useQueryClient', () => w], 6283);
	},
	7914,
	(e) => {
		e.v({
	...
	(e) => {
		...
		var t = e.i(4601),
			...
			o = class extends a.Subscribable {
				...
				build(e, t, r) {
					let s = t.queryKey,
						a = t.queryHash ?? (0, n.hashQueryKeyByOptions)(s, t),
						o = this.get(a);
					return (
						o ||
							((o = new i.Query({
				...
				async execute(e) {
					...
					try {
						if (n) t();
							...
							(this.#p({ type: 'pending', variables: e, isPaused: i }),
								await this.#v.config.onMutate?.(e, this, r));
					...
					((this.state = ((t) => {
						...
						s.notifyManager.batch(() => {
							(this.#m.forEach((t) => {
								...
								this.#v.notify({ mutation: this, type: 'updated', action: e }));
						}));
				}
			},
			h = a,
			f = class extends h.Subscribable {
				...
				resumePausedMutations() {
					...
					return s.notifyManager.batch(() =>
						Promise.all(e.map((e) => e.continue().catch(n.noop))),
					);
				}
			};
		function d(e) {
			...
			return {
				onFetch: (t, r) => {
					let i = t.options,
						...
						l = async () => {
							let r = !1,
								l = (0, n.ensureQueryFn)(t.options, t.fetchOptions),
								h = async (e, i, s) => {
									let a;
							...
							if (s && a.length) {
								...
								let t = e ?? a.length;
								do {
									let e = 0 === c ? (o[0] ?? i.initialPageParam) : v(i, u);
									if (c > 0 && null == e) break;
									((u = await h(u, e)), c++);
								} while (c < t);
							}
		...
		function v(e, { pages: t, pageParams: r }) {
			let n = t.length - 1;
		...
		var b = class {
				...
				mount() {
					(this.#C++,
						1 === this.#C &&
							((this.#E = p.focusManager.subscribe(async (e) => {
				...
				isMutating(e) {
					return this.#v.findAll({ ...e, status: 'pending' }).length;
				}
				getQueryData(e) {
				...
				setQueryData(e, t, r) {
					let i = this.defaultQueryOptions({ queryKey: e }),
						s = this.#S.get(i.queryHash),
						a = s?.state.data,
						o = (0, n.functionalUpdate)(t, a);
					if (void 0 !== o)
						return this.#S.build(this, i).setData(o, { ...r, manual: !0 });
				}
				...
				cancelQueries(e, t = {}) {
					...
					return Promise.all(
						s.notifyManager.batch(() =>
							this.#S.findAll(e).map((e) => e.cancel(r)),
						),
					)
						.then(n.noop)
						.catch(n.noop);
				...
				setQueryDefaults(e, t) {
					this.#_.set((0, n.hashKey)(e), { queryKey: e, defaultOptions: t });
				}
				getQueryDefaults(e) {
					let t = [...this.#_.values()],
						r = {};
					return (
						t.forEach((t) => {
							(0, n.partialMatchKey)(e, t.queryKey) &&
				...
				setMutationDefaults(e, t) {
					this.#O.set((0, n.hashKey)(e), { mutationKey: e, defaultOptions: t });
				}
				getMutationDefaults(e) {
					...
					return (
						t.forEach((t) => {
							(0, n.partialMatchKey)(e, t.mutationKey) &&
								Object.assign(r, t.defaultOptions);
						}),
						r
					);
				...
				defaultQueryOptions(e) {
					...
					return (
						t.queryHash ||
							(t.queryHash = (0, n.hashQueryKeyByOptions)(t.queryKey, t)),
				...
				clear() {
					(this.#S.clear(), this.#v.clear());
				}
			},
			g = e.i(6283),
			w = e.i(7914);
		let S = {
			className: w.default.className,
			style: { fontFamily: "'Geist', 'Geist Fallback'", fontStyle: 'normal' },
		};
		null != w.default.variable && (S.variable = w.default.variable);
		var _ = e.i(4510);
		let O = {
			className: _.default.className,
			style: {
				fontFamily: "'Geist Mono', 'Geist Mono Fallback'",
				fontStyle: 'normal',
			},
		};
		null != _.default.variable && (O.variable = _.default.variable);
		var C = e.i(7046);
		let E = new b();
		e.s(
			[
				...
				(e) => {
					let n,
						i,
						s = (0, r.c)(4),
						{ Component: a, pageProps: o } = e;
					return (
						s[0] === Symbol.for('react.memo_cache_sentinel')
							? ((n = (0, t.jsx)(C.default, {
									children: (0, t.jsx)('title', { children: 'Words' }),
								})),
								(s[0] = n))
							: (n = s[0]),
						s[1] !== a || s[2] !== o
							? ((i = (0, t.jsxs)(t.Fragment, {
									children: [
										n,
										(0, t.jsx)('div', {
											className: `${S.className} ${O.className}`,
											children: (0, t.jsx)(g.QueryClientProvider, {
												client: E,
												children: (0, t.jsx)(a, { ...o }),
											}),
										}),
									],
								})),
	...
	(e) => {
		e.v((t) =>
			Promise.all(
				['static/chunks/056c35ea6df6eb5c.js'].map((t) => e.l(t)),
			).then(() => t(3503)),
		);
	},
	2969,
